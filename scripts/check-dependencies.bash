...
for P in $PROTOCOL_VERSIONS; do
    ...
    if [ "$RS_HCNET_XDR_REVISION" != "$RS_HCNET_XDR_REVISION_FROM_CORE" ]; then
	    echo "The Core revision used in protocol $P integration tests (${CORE_CONTAINER_REVISION}) uses a different revision of https://github.com/shantanu-hashcash/rs-hcnet-xdr"
	    echo
